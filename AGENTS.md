...
2. **Data Pipeline (`src/data/news-data.ts`)**:
   ...
   - Target **10–12 distinct synthesized articles per daily scan run**, covering regional bureaus (Delhi, Kolkata, Tripura, Assam, Siliguri) and media formats (RSS press & YouTube video dispatches).
