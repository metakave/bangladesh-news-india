...
export const BREAKING_NEWS_ALERTS: BreakingAlert[] = [
  ...
  },
  {
    ...
    sourceBureau: 'Delhi',
    sentiment: 'positive',
    url: 'https://indianexpress.com/article/india/india-bangladesh-to-discuss-resuming-maitree-bandhan-mitali-express-train-services-10867306/',
  },
  {
    id: 'b3',
    headlineBn: 'বাংলাদেশে হিন্দু সাংবাদিকের রহস্যজনক মৃত্যু: সমকাল পত্রিকা কার্যালয়ে মরদেহ উদ্ধার, তদন্তের দাবি',
    headlineEn: 'Death of Hindu journalist in Dhaka: Body found inside newspaper office, swift probe demanded',
    timeAgoBn: '৫২ মিনিট আগে',
    timeAgoEn: '52m ago',
    sourceName: 'Amar Ujala',
    sourceBureau: 'Delhi',
    sentiment: 'negative',
    url: 'https://www.amarujala.com/world/death-of-hindu-journalist-in-bangladesh-body-found-hanging-in-samakal-office-awami-league-raises-questions-2026-09-12',
  },
  {
    id: 'b4',
    headlineBn: 'কলকাতায় চিন্ময় প্রভুর বিষয় নিয়ে রাজনৈতিক প্রতিক্রিয়া: সুর চড়ালেন বিরোধী দলনেতা',
    headlineEn: 'Kolkata political leaders express concern over jailed Bangladesh monk Chinmoy Krishna Das',
    timeAgoBn: '১ ঘণ্টা আগে',
    timeAgoEn: '1h ago',
    sourceName: 'Sangbad Pratidin',
    sourceBureau: 'Kolkata',
    sentiment: 'negative',
    url: 'https://www.sangbadpratidin.in/kolkata/cm-suvendu-adhikari-recalls-his-own-painful-incident-relating-chinmoy-prabhus-condition-in-bangaldesh/pid/1335141/',
  }
];
...
export const SCANNED_NEWS_ITEMS: NewsItem[] = [
  ...
  },
  {
    ...
    source: {
      ...
      bureau: 'Delhi',
      language: 'Hindi',
      originalUrl: 'https://www.amarujala.com/world/death-of-hindu-journalist-in-bangladesh-body-found-hanging-in-samakal-office-awami-league-raises-questions-2026-09-12',
  ...
  },
  {
    ...
    source: {
      ...
      bureau: 'Delhi',
      language: 'English',
      originalUrl: 'https://www.thehindu.com/news/international/saima-wazed-hasina-daughter-resigns-as-who-regional-director-fraud-allegations-bangladesh/article71450449.ece',
  ...
  },
  {
    ...
    source: {
      ...
      bureau: 'Kolkata',
      language: 'Bengali',
      originalUrl: 'https://www.sangbadpratidin.in/kolkata/cm-suvendu-adhikari-recalls-his-own-painful-incident-relating-chinmoy-prabhus-condition-in-bangaldesh/pid/1335141/',
  ...
  },
  {
    ...
    source: {
      ...
      bureau: 'Kolkata',
      language: 'Bengali',
      originalUrl: 'https://www.anandabazar.com/business/petrapole-benapole-border-trade-24-hour-cargo-clearance-record-volume-hilsa-supply/cid/1548920',
  ...
  },
  {
    ...
    source: {
      ...
      bureau: 'Delhi',
      language: 'Hindi',
      originalUrl: 'https://www.jagran.com/news/national-bsf-intensifies-drone-surveillance-on-india-bangladesh-border-in-meghalaya-and-cooch-behar-23847291.html',
