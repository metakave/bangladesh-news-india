...
export const SCANNED_NEWS_ITEMS: NewsItem[] = [
  ...
  },
  {
    ...
    readTimeEn: '3 min read',
    imageUrl: 'https://images.unsplash.com/photo-1473341304170-971dccb5ac1e?w=1200&auto=format&fit=crop&q=80',
    tags: ['Times of India', 'Adani Power', 'Godda Plant', 'BPDB', 'Energy Transmission', 'Dhaka Grid'],
  },
  {
    id: '22',
    ...
    tags: ['The Hindu', 'Indian Visa', 'IVAC Dhaka', 'Student Visa', 'Medical Tourism', 'MEA Delhi'],
  },
  {
    id: '23',
    slug: 'anandabazar-teesta-water-sharing-data-exchange-joint-river-commission',
    title: 'তিস্তা ও ৫৪টি অভিন্ন নদীর অববাহিকায় রিয়েল-টাইম হাইড্রোলজিক্যাল তথ্য আদান-প্রদানে যৌথ নদী কমিশনের কারিগরি সমন্বয়',
    englishTitle: 'Joint Rivers Commission Enhances Real-Time Hydrological & Flood Forecasting Data Sharing on Teesta Basin',
    banglaTitle: 'তিস্তা ও ৫৪টি অভিন্ন নদীর অববাহিকায় রিয়েল-টাইম হাইড্রোলজিক্যাল তথ্য আদান-প্রদানে যৌথ নদী কমিশনের কারিগরি সমন্বয়',
    summaryBn: 'আনন্দবাজার পত্রিকার কলকাতা ব্যুরো জানায়, তিস্তা, ধরলা, দুধকুমার ও পদ্মা সহ ৫৪টি অভিন্ন নদীর বর্ষা মৌসুমের পানির প্রবাহ ও বন্যা পূর্বাভাস সংক্রান্ত তথ্য আদান-প্রদান আরও নির্ভুল ও স্বয়ংক্রিয় করতে যৌথ নদী কমিশন (JRC)-এর কারিগরি দল যৌথ টেলিমেট্রি ব্যবস্থা চালুর কাজ শুরু করেছে। এর ফলে তিস্তার উজানে হঠাৎ ঢল বা পানি বাড়ার তথ্য ডালিয়া ব্যারেজ কর্তৃপক্ষ কয়েক ঘণ্টা আগেই পেয়ে যাবে।',
    summaryEn: 'Anandabazar Patrika reports from Kolkata that technical working groups under the Indo-Bangladesh Joint Rivers Commission (JRC) are upgrading automated telemetry sensor networks across 54 transboundary rivers, including the Teesta basin. The real-time hydro-data exchange allows downstream barrage engineers in Nilphamari to receive early flood warnings and plan reservoir discharge.',
    keyPointsBn: [
      'জলপাইগুড়ির গজলডোবা এবং নীলফামারীর ডালিয়ার মধ্যে স্বয়ংক্রিয় পানির স্তর ও বৃষ্টিপাতের তথ্য বিনিময়।',
      'আকস্মিক বন্যায় নদী তীরবর্তী কৃষিজমি ও ফসলের ক্ষয়ক্ষতি কমাতে যৌথ প্রযুক্তিগত নজরদারি।',
      'পানি সম্পদ মন্ত্রণালয়ের দীর্ঘমেয়াদী তিস্তা অববাহিকা ব্যবস্থাপনা পর্যালোচনায় এই তথ্য ব্যবহৃত হবে।'
    ],
    keyPointsEn: [
      'Automated telemetry synchronization between Gajoldoba barrage in North Bengal and Dalia in Rangpur.',
      'Advanced flood advisory lead-time significantly mitigates agricultural and riparian community vulnerabilities.',
      'Hydrological datasets will inform long-term Teesta transboundary basin management consultations.'
    ],
    category: 'diplomacy',
    categoryLabelBn: 'কূটনীতি ও নদী ব্যবস্থাপনা',
    categoryLabelEn: 'Diplomacy & Water',
    sentiment: 'positive',
    sentimentReasonBn: 'বন্যা নিয়ন্ত্রণ ও অভিন্ন নদী অববাহিকায় বিজ্ঞানভিত্তিক তথ্য আদান-প্রদানের ইতিবাচক সহযোগিতা।',
    sentimentReasonEn: 'Underlines constructive technical cooperation and disaster-risk reduction across shared river ecosystems.',
    source: {
      name: 'Anandabazar Patrika',
      bureau: 'Kolkata',
      language: 'Bengali',
      originalUrl: 'https://www.anandabazar.com/world',
      originalHeadline: 'তিস্তা ও অভিন্ন নদীর বন্যা সতর্কবার্তা: রিয়েল টাইম তথ্য বিনিময়ে যৌথ নদী কমিশনের উদ্যোগ',
      scannedAt: '40 mins ago',
    },
    ...
    readTimeEn: '3 min read',
    imageUrl: 'https://images.unsplash.com/photo-1544551763-46a013bb70d5?w=1200&auto=format&fit=crop&q=80',
    tags: ['Anandabazar Patrika', 'Teesta River', 'Joint Rivers Commission', 'Flood Warning', 'Water Resources', 'Kolkata Bureau'],
  },
  {
    id: '24',
    slug: 'business-standard-petrapole-benapole-24-hour-green-corridor-export',
    title: 'Petrapole-Benapole 24x7 Green Corridor Handles Record 1,200 Cargo Trucks Daily; Eliminates Border Congestion',
    englishTitle: 'Petrapole-Benapole 24x7 Green Corridor Handles Record 1,200 Cargo Trucks Daily; Eliminates Border Congestion',
    banglaTitle: 'পেট্রাপোল-বেনাপোল ২৪ ঘণ্টার গ্রিন করিডোরে প্রতিদিন রেকর্ড ১,২০০ পণ্যবাহী ট্রাক খালাস; যানজট সম্পূর্ণ দূর',
    summaryBn: 'বিজনেস স্ট্যান্ডার্ডের বাণিজ্য প্রতিবেদনে বলা হয়েছে, ভারত ও বাংলাদেশের বৃহত্তম স্থলবন্দর পেট্রাপোল-বেনাপোলে চব্বিশ ঘণ্টা পণ্য পরিবহন ও স্বয়ংক্রিয় স্ক্যানিং ব্যবস্থা পুরোদমে কার্যকর হওয়ার পর দৈনিক পণ্যবাহী ট্রাক চলাচলের সংখ্যা রেকর্ড ১,২০০ ছাড়িয়েছে। পূর্বে যেখানে পণ্য ছাড়পত্রে ৩ থেকে ৪ দিন অপেক্ষা করতে হতো, এখন তা নেমে এসেছে মাত্র ৬ থেকে ৮ ঘণ্টায়।',
    summaryEn: 'Business Standard reports that the operationalization of round-the-clock integrated cargo processing and non-intrusive container scanning at the Petrapole-Benapole Land Port has scaled daily transshipment past 1,200 commercial trucks. The reduction in border dwell-time from 72+ hours to under 8 hours has significantly reduced supply chain demurrage costs for bilateral trade.',
    keyPointsBn: [
      'তৈরি পোশাকের কাঁচামাল, সুতা এবং পচনশীল খাদ্যপণ্যের ছাড়পত্রে অগ্রাধিকার ভিত্তিক গ্রিন চ্যানেল।',
      'ডিজিটাল ই-গেট পাসের মাধ্যমে পরিবহন ব্যয় ও ডেমারেজ চার্জে কোটি টাকার সাশ্রয়।',
      'বেনাপোল কাস্টমস ও ল্যান্ড পোর্ট অথরিটি অফ ইন্ডিয়ার যৌথ পরিচালনায় লজিস্টিক গতি বৃদ্ধি।'
    ],
    keyPointsEn: [
      'Dedicated green lanes prioritize garment inputs, raw cotton, industrial machinery, and perishable exports.',
      'Digital e-gate pass architecture saves millions in transporter demurrage and logistics holding costs.',
      'Joint oversight by Land Ports Authority of India (LPAI) and Benapole Customs enhances trade velocity.'
    ],
    category: 'trade',
    categoryLabelBn: 'সীমান্ত বাণিজ্য ও বন্দর',
    categoryLabelEn: 'Cross-Border Trade',
    sentiment: 'positive',
    sentimentReasonBn: 'বাণিজ্য সহজীকরণ, বন্দর দক্ষতা বৃদ্ধি এবং অর্থনৈতিক লেনদেনের উল্লেখযোগ্য অগ্রগতি।',
    sentimentReasonEn: 'Illustrates major logistical efficiency gains, reduced trade costs, and robust bilateral commercial throughput.',
    source: {
      name: 'Business Standard',
      bureau: 'Delhi',
      language: 'English',
      originalUrl: 'https://www.business-standard.com/economy',
      originalHeadline: 'Petrapole-Benapole cargo clearance scales record daily volume under 24x7 transit framework',
      scannedAt: '55 mins ago',
    },
    publishedAt: '2026-09-12T09:20:00Z',
    readTimeBn: '৪ মিনিট পাঠ',
    readTimeEn: '4 min read',
    imageUrl: 'https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?w=1200&auto=format&fit=crop&q=80',
    tags: ['Business Standard', 'Petrapole', 'Benapole', 'Logistics', 'RMG Export', 'Cross-Border Trade'],
  }
];
