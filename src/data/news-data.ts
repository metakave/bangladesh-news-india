...
export const BREAKING_NEWS_ALERTS: BreakingAlert[] = [
  {
    ...
    sourceBureau: 'Delhi',
    sentiment: 'positive',
    url: 'https://www.thehindu.com/news/national/mea-confirms-diplomatic-engagement-with-dhaka-on-emergency-medical-visas/article68624102.ece',
  },
  {
    id: 'b2',
    ...
    sentiment: 'positive',
    url: 'https://www.anandabazar.com/business/petrapole-benapole-border-trade-24-hour-cargo-clearance-record-volume-hilsa-supply/cid/1548920',
  },
  {
    id: 'b3',
    ...
    sourceBureau: 'Delhi',
    sentiment: 'negative',
    url: 'https://www.jagran.com/news/national-bsf-heightens-vigil-along-meghalaya-and-tripura-frontiers-23847310.html',
  },
];
...
export const SCANNED_NEWS_ITEMS: NewsItem[] = [
  ...
  },
  {
    ...
    source: {
      ...
      bureau: 'Delhi',
      language: 'Hindi',
      originalUrl: 'https://www.amarujala.com/tripura/tripura-government-urges-centre-to-expedite-transit-via-chittagong-port-and-maitri-setu-20260911-382910',
  ...
  },
  {
    ...
    source: {
      ...
      bureau: 'Kolkata',
      language: 'Bengali',
      originalUrl: 'https://www.sangbadpratidin.in/sports/cricket/eden-gardens-prepares-for-india-bangladesh-series-bcb-satisfied-with-kolkata-police-security/pid/1332840/',
  ...
  },
  {
    ...
    source: {
      ...
      bureau: 'Delhi',
      language: 'English',
      originalUrl: 'https://www.thehindu.com/opinion/editorial/engaging-dhaka-on-indias-strategic-approach-to-bangladeshs-transition/article68623491.ece',
