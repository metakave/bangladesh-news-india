...
export const BREAKING_NEWS_ALERTS: BreakingAlert[] = [
  ...
  },
  {
    ...
    sourceBureau: 'Delhi',
    sentiment: 'negative',
    url: 'https://www.jagran.com/search/bangladesh',
  },
];
...
export const SCANNED_NEWS_ITEMS: NewsItem[] = [
  ...
  },
  {
    ...
    source: {
      ...
      bureau: 'Delhi',
      language: 'Hindi',
      originalUrl: 'https://www.jagran.com/search/bangladesh',
  ...
  },
  {
    ...
    source: {
      ...
      bureau: 'Kolkata',
      language: 'Bengali',
      originalUrl: 'https://eisamay.com/search?q=bangladesh',
  ...
  },
  {
    ...
    source: {
      ...
      bureau: 'Kolkata',
      language: 'Bengali',
      originalUrl: 'https://www.sangbadpratidin.in/category/bangladesh/',
